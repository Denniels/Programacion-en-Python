...
if arg2 == 'mayor':
    print('los productos mayores al umbral son: ',{",".join(filtrar_mayor(precios, valor_consulta))})

elif arg2 == 'menor':
    print('los productos menores al umbral son: ',{",".join(filtrar_menor(precios, valor_consulta))})